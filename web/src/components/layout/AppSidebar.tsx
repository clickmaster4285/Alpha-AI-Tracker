                      ...
                      {visibleChildren.map(child => (
                        <Link
                          ...
                          className={`block px-3 py-2 rounded-md text-sm transition-colors
                            ${pathname === child.path ? 'text-sidebar-primary font-semibold bg-sidebar-accent/60' : 'text-sidebar-foreground/70 hover:text-sidebar-foreground hover:bg-sidebar-accent/30'}`}
                        >
                          {child.label}
                        </Link>
                      ))}
