...
> **Last audited:** 2026-09-04 (per-app usage aggregate for /employee-journey/apps)
> **Changelog:**
...
| `/employee-journey/apps` | App usage | Server (`GET /app-sessions/usage`, per-app aggregate; renders `lastClosed - firstOpened` since 2026-09-04) | ✅ |
