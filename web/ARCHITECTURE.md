...
| `/settings/terms-and-conditions` | **Per-feature T&C content management** — editable cards for featured (cannot delete) and custom (can create/delete) T&C terms. Uses `termsContentApi` (list/get/update/create/delete). | Server (`/terms-content`) | ✅ |
